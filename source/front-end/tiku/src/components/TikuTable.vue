    ...
    <el-main>
      ...
      <el-row>
        ...
        >
          ...
          <el-table-column prop="sound" label="语音" width="200"></el-table-column>
          <el-table-column prop="pictures" label="多图片" width="220"></el-table-column>
          <el-table-column
            prop="tag"
            label="标签"
            width="100"
          ...
          <el-table-column fixed="right" label="操作" width="250">
            <template slot-scope="scope">
              ...
              <el-button size="mini" @click="centerDialogVisible = true">修改标签</el-button>
